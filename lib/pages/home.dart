      ...
      children: [
        ...
        ImageSide(
          ...
          ttb: TitleTextButton(
            ...
            button: RaisedButton(
              onPressed: () {},
              child: Text('Mehr lesen', style: TextStyle(color: Colors.black)),
            ),
          ),
        ),
        ImageSide(
          ...
          ttb: TitleTextButton(
            title: Text('Ergotherapie im Wandel',
                style: TextStyle(color: Color.fromRGBO(44, 65, 104, 1.0))),
            text: Text(
            ...
            button: RaisedButton(
              ...
              onPressed: () {},
              child: Text('Mehr lesen', style: TextStyle(color: Colors.white)),
            ),
          ),
        ),
        ImageSide(
        ...
        TextBanner(
          ...
          content: TitleTextButton(
            title:
                Text('Interessiert?!', style: TextStyle(color: Colors.white)),
            text: Text(
