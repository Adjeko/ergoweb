    ...
    return Scaffold(
      body: Stack(
        children: [
                    ...
                    button: Padding(
                      ...
                      child: RaisedButton(
                        ...
                        child: Padding(
                          ...
                          child:
                              Texts.latoButtonText('Mehr lesen', Colors.black),
                        ),
                      ),
                    ),
                  ),
                    ...
                    button: Padding(
                      ...
                      child: RaisedButton(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(15.0),
                          child:
                              Texts.latoButtonText('Mehr lesen', Colors.white),
                        ),
                      ),
                    ),
                  ),
                ...
                ImageSide(
                  ...
                  ttb: TitleTextButton(
                    title: Align(
                      alignment: Alignment.centerLeft,
                      child: Texts.latoHeader(
                          'Über uns', ErgoColors.logoTextAccent),
                    ),
                    text: Texts.latoText(
          ...
          Navbar(scroll: _scrollController),
        ],
      ),
    );
  }
